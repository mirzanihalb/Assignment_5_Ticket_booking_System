...
{
    internal class Booking_with_set
    {
        ...
        public SortedSet<Customer> Customers { get; set; }
        ...
        public Booking_with_set()
        {
            // Default constructor

        }

        public Booking_with_set(Event event_obj, SortedSet<Customer> customers, int numTickets)
        {
