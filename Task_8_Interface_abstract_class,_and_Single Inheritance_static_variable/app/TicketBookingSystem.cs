...
using Task_8_Interface_abstract_class__and_Single_Inheritance_static_variable.bean;
using Task_8_Interface_abstract_class_and_Single_Inheritance_static_variable;

namespace Task_8_Interface_abstract_class__and_Single_Inheritance_static_variable.app
{
        ...
        public void run()
        {
            ...
            while (true)
            {
                ...
                switch (choice)
                {
                    ...
                    case "display_events":
                        List<Event> all_events = bookingSystem.getEventDetails();
                        flag = 0;
