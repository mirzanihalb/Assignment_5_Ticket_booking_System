...
namespace Task_5_Inheritance_and_polymorphism.Model
{
    internal class Sports : Event
    {
        ...
        public Sports(string event_name, DateTime event_date, TimeSpan event_time, string venue_name, int total_seats, decimal ticket_price, string sports_name, string teams_name) : base(event_name, event_date, event_time, venue_name, total_seats, ticket_price, EventType.Sports)
        {
